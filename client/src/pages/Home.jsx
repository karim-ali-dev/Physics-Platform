    ...
    <div>
      ...
      <section className="container-x py-24">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {courses.map((c, i) => (
            <Reveal key={c.id} className="h-full" delay={(i % 3) * 90}>
              <div className="card hover-lift flex h-full flex-col p-6 hover:border-brand-500/40">
      ...
      <section className="border-y border-white/5 bg-ink-900/50 py-20">
        <div className="container-x grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {highlights.map((h, i) => (
            <Reveal key={h.title} className="h-full" delay={(i % 4) * 100}>
              <div className="card hover-lift h-full p-6 text-center hover:border-brand-500/40">
                <span
      ...
      <section className="container-x py-16">
        <Reveal>
          <div className="card hover-lift relative overflow-hidden p-8 sm:p-10">
      ...
      <section className="container-x pb-24">
        <Reveal>
          <div className="card hover-lift relative overflow-hidden p-10 text-center sm:p-14">
